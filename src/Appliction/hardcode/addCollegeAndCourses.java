...
public class addCollegeAndCourses extends HardCode {
    ...
    public void run() {
        ...
        math.addListOfCourses(new courses(10, 25726, 1, "dr.pornaki", "jabr", "01:00", "09:00", "1403/3/10", "t", true, math));
        ...
        phisics.addListOfCourses(new courses(70, 2026, 1, "dr.mostajeran", "ap", "11:00", "09:00", "1403/3/10", "general", true, phisics));
        phisics.addListOfCourses(new courses(10, 2726, 1, "dr.pornaki", "jabr", "01:00", "09:00", "1403/3/10", "t", true, phisics));
        ...
        ce.addListOfCourses(new courses(70, 20526, 1, "dr.mostajeran", "ap", "01:00", "09:00", "1405/3/10", "t", true, ce));
        ce.addListOfCourses(new courses(10, 21726, 1, "dr.pornaki", "jabr", "16:00", "09:00", "1404/3/10", "t", true, ce));
